...
export interface ListOrderResponseItem {
    ...
    /**
     * @generated from protobuf field: string xendit_nvoice_url = 8
     */
    xenditNvoiceUrl: string;
}
/**
...
class CreateOrderRequest$Type extends MessageType<CreateOrderRequest> {
    constructor() {
        super("order.CreateOrderRequest", [
            ...
            { no: 5, name: "products", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CreateOrderRequestProductItem }
        ]);
    }
...
class ListOrderAdminResponseItem$Type extends MessageType<ListOrderAdminResponseItem> {
    constructor() {
        super("order.ListOrderAdminResponseItem", [
            ...
            { no: 7, name: "products", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ListOrderAdminResponseItemProduct }
        ]);
    }
...
class ListOrderResponseItem$Type extends MessageType<ListOrderResponseItem> {
    constructor() {
        super("order.ListOrderResponseItem", [
            ...
            { no: 5, name: "total", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ },
            { no: 6, name: "created_at", kind: "message", T: () => Timestamp },
            { no: 7, name: "products", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ListOrderResponseItemProduct },
            { no: 8, name: "xendit_nvoice_url", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated order.ListOrderResponseItemProduct products */ 7:
                    ...
                    break;
                case /* string xendit_nvoice_url */ 8:
                    message.xenditNvoiceUrl = reader.string();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: ListOrderResponseItem, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.xenditNvoiceUrl !== "")
            writer.tag(8, WireType.LengthDelimited).string(message.xenditNvoiceUrl);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
